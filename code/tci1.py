...
def estimate_layer_intwin(layer, stimuli, segment_durs, in_sr, out_sr):
    ...
    print("Model loaded")
    response_pairs = infer_sequence_pair(
    ...
    print("infer seq done")
    
    SAR_pairs = rearrange_sequence_pair(
...
def main():
    stimuli, in_sr = load_stimuli('segments-librispeech-1k/')
